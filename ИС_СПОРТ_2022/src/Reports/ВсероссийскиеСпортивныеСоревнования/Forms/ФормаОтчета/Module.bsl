...
Процедура ОтчетТабличныйДокументОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	// {Рарус adilas #22157 -Отчет Всероссийские спортивные соревнования 2021.12.09
	///////////////////////////////////////////////////////////////////////////
	// Типовой код
	...
	Иначе
		...
		ОткрытьФорму("Отчет.ВсероссийскиеСпортивныеСоревнования.Форма.ФормаРасшифровки", ПараметрыФормы, ЭтаФорма);
...
Функция ТиповаяРасшифровкаВозможнаНаСервере(Расшифровка) 
	...
	Если ТипЗнч(ЗначенияПолейРасшифровки[0].Значение) = Тип("СправочникСсылка.ВидыСпорта") Тогда
