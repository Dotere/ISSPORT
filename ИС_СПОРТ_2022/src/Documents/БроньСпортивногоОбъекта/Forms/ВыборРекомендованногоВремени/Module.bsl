...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	БроньОбъект = ДанныеФормыВЗначение(Параметры.Бронь, Тип("ДокументОбъект.БроньСпортивногоОбъекта"));
...
Процедура ОбновитьСервер()
	...
	Для Каждого СтрокаБронь Из ТаблицаБроней Цикл
		...
		//НоваяСтрока.ПериодСтрокой = Отсутствия.МестныйПериодСтрокой(СтрокаБронь.ДатаНачала,
