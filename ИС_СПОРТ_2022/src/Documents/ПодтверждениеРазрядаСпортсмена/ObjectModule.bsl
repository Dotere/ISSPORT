...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.ПрисвоениеРазряда") Тогда
		ЗаполнитьЗначенияСвойств(ЭтотОбъект,ДанныеЗаполнения,"ВидСпорта, Организация");
		Спортсмены.Загрузить(ДанныеЗаполнения.Спортсмены.Выгрузить(, "Спортсмен, Разряд"));
