...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	//ОткрытьФорму("Документ.ИсключениеСпортсменовИзКоманды.ФормаСписка", ПараметрыФормы, ПараметрыВыполненияКоманды.Источник, ПараметрыВыполненияКоманды.Уникальность, ПараметрыВыполненияКоманды.Окно, ПараметрыВыполненияКоманды.НавигационнаяСсылка);
	#Если Не ВебКлиент Тогда
		Печать("Документ.ИсключениеСпортсменовИзГруппы", "ПФ_DOC_СлужебнаяЗаписка",  ПараметрКоманды, "Служебная записка Word");
	#Иначе
