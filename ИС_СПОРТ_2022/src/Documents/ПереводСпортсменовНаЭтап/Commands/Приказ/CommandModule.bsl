...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	#Если Не ВебКлиент Тогда
		Печать("Документ.ПереводСпортсменовНаЭтап", "ПФ_DOC_ПриказОПереводеСЭтапаНаЭтап",  ПараметрКоманды, "Приказ о переводе спортсменов с этапа на этап Word");
	#Иначе
		УправлениеПечатьюКлиент.ВыполнитьКомандуПечати
		(
		"Документ.ПереводСпортсменовНаЭтап",
		"ПФ_MXL_ПриказПереводНаЭтап",
		ПараметрКоманды,
		Неопределено,
		Неопределено
		);
